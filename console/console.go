...
func (c *Console) init(preload []string) error {
	...
	flatten := "var iov = web3.eth; var personal = web3.personal; "
	for api := range apis {
		if api == "web3" {
...
func (c *Console) Welcome() {
	...
	fmt.Fprintf(c.printer, "Welcome to the Giov JavaScript console!\n\n")
	c.jsre.Run(`
	...
	if apis, err := c.client.SupportedModules(); err == nil {
		...
		fmt.Fprintln(c.printer," iov:1.0 net:1.0 persional:1.0 rpc:1.0 web3:1.0")
	}
