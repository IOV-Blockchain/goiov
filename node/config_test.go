...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "giov.ipc", false, filepath.Join(os.TempDir(), "giov.ipc")},
		{"data", "giov.ipc", false, "data/giov.ipc"},
		{"data", "./giov.ipc", false, "./giov.ipc"},
		{"data", "/giov.ipc", false, "/giov.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "giov.ipc", true, `\\.\pipe\giov.ipc`},
		{"data", "giov.ipc", true, `\\.\pipe\giov.ipc`},
		{"data", `\\.\pipe\giov.ipc`, true, `\\.\pipe\giov.ipc`},
	}
