...
func TestParseEnsAPIAddress(t *testing.T) {
	for _, x := range []struct {
	...
	}{
		{
			...
			value:       "/data/testnet/giov.ipc",
			endpoint:    "/data/testnet/giov.ipc",
		},
		{
		...
		},
		{
			...
			value:       "test:/data/testnet/giov.ipc",
			endpoint:    "/data/testnet/giov.ipc",
			tld:         "test",
		},
		{
		...
		},
		{
			...
			value:       "314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/giov.ipc",
			endpoint:    "/data/testnet/giov.ipc",
		...
		},
		{
			...
			value:       "test:314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/giov.ipc",
			endpoint:    "/data/testnet/giov.ipc",
			addr:        common.HexToAddress("314159265dD8dbb310642f98f50C066173C1259b"),
			tld:         "test",
		},
