...
import (
	...
	"github.com/CarLiveChainCo/goiov/internal/build"
)
...
var (
	...
	debExecutables = []debExecutable{
		...
		{
			Name:        "giov",
			Description: "IOV Protocol CLI client.",
		},
		{
			Name:        "puppeth",
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/CarLiveChainCo/goiov/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "--tags", "ios", "-v", "github.com/CarLiveChainCo/goiov/mobile")
