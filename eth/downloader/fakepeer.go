...
func (p *FakePeer) Head(string) (common.Hash, *big.Int) {
...
func (p *FakePeer) RequestHeadersByHash(hash common.Hash, amount int, skip int, reverse bool, appId string) error {
	var (
...
func (p *FakePeer) RequestHeadersByNumber(number uint64, amount int, skip int, reverse bool, appId string) error {
	var (
		headers []*types.Header
		unknown bool
	)
...
func (p *FakePeer) RequestBodies(hashes []common.Hash, appId string) error {
	var (
...
func (p *FakePeer) RequestReceipts(hashes []common.Hash, appId string) error {
...
func (p *FakePeer) RequestNodeData(hashes []common.Hash, appId string) error {
	var data [][]byte
	for _, hash := range hashes {
